    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('/login') }}" method="post" data-type="json" role="form" class="form-inline" id="login-form">
                    ...
                    <div class="help-block with-errors errorPassword" style="color: red"></div>
                    <div class="form-group ">
