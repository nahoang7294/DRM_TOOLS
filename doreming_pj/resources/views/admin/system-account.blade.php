	...
	<div class="content" >
		<div class="row">
			...
			<div class="col-md-10 justifi-content-center">
				<div align="center"><h2 class="table-title">Tài khoản hệ thống</h2></div>
				...
				<table class="table table-bordered table-hover" style="width: 100%;">
					<thead class="thead-light">
						...
						<th class="text-align" style="width: 14%;">Phân quyền</th>
						<th  class="text-align" style="width: 14%;">Trạng trái tài khoản</th>
					...
					<tbody>
						<tr>
							...
							<td>A&B Company</td>
							<td class="text-align">Admin</td>
							<td>Đang hoạt động</td>
							<td></td>
							<td>
								<div>
									<button class="btn btn-danger mb-1">Thay đổi quyền</button>
								</div>
								<div>
									<button class="btn btn-danger">Dừng tài khoản</button>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>A&BC Company</td>
							<td class="text-align">Manager</td>
							<td>Đang hoạt động</td>
							<td></td>
							<td>
								<div>
						...
						<tr>
							...
							<td>A&CD Company</td>
							<td class="text-align">Acconting</td>
							<td>Đang hoạt động</td>
							<td></td>
							<td>
								<div>
						...
						<tr>
							...
							<td>A&VB Company</td>
							<td class="text-align">Accounting</td>
							<td>Đang hoạt động</td>
							<td></td>
							<td>
								<div>
