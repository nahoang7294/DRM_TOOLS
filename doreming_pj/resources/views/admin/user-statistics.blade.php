	...
	<div class="content" >
		<div class="row">
			...
			<div class="col-md-10 justifi-content-center">
				<div align="center"><h2 class="table-title">Thống kê người dùng</h2></div>

				<table class="table table-bordered table-hover" style="width: 100%;">
					<thead class="thead-light">
						<th class="text-align" style="width: 55px;">ID</th>
						<th class="text-align" style="width: 180px;">Email</th>
						<th class="text-align" style="width: 170px;">Công ty</th>
						<th class="text-align" style="width: 150px;">Tổng số báo cáo đã xuất</th>
						<th  class="text-align" style="width: 150px;">Tổng số báo cáo đã xuất trong 30 ngày</th>
						<th  class="text-align" style="width: 120px;">Tổng số báo cáo đã xuất trong 60 ngày</th>
						<th class="text-align" style="width: 275px;">Hành động</th>
					</thead>
					<tbody>
						<tr>
							<td>1</td>
							...
							<td>
								<div>
									<button class="btn btn-danger">Xem chi tiết lịch sử xuất báo cáo</button>
								</div>
							</td>
						</tr>
						<tr>
